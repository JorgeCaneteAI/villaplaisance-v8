...
Database::insert('vp_sections', [
    ...
    'content'    => json_encode([
        ...
        'lede'  => "En juillet et en août, Villa Plaisance ouvre ses portes en location complète — quatre chambres, dix personnes, piscine privée exclusive, cuisine équipée et terrasses face aux vignes.",
        'tags'  => [
            "02 · Maison d'hôtes · Juillet – août",
            'Du samedi au samedi',
        ],
        'ctas' => [
            ['label' => 'Demander une semaine', 'url' => '/contact', 'style' => 'primary'],
...
Database::insert('vp_sections', [
    ...
    'content'    => json_encode([
        ...
        'items' => [
            ...
            ['label' => 'Séjour minimum',   'value' => '7 nuits · sam → sam'],
        ],
    ], JSON_UNESCAPED_UNICODE | JSON_UNESCAPED_SLASHES),
    'position'   => 2,
    'active'     => 1,
...
Database::insert('vp_sections', [
    ...
    'content'    => json_encode([
        ...
        'display'       => 'key-value',
        'rows' => [
            ['key' => 'Période',         'value' => '**Juillet et août uniquement**'],
            ['key' => 'Arrivée',         'value' => 'À partir de 17h'],
            ['key' => 'Départ',          'value' => 'Avant 10h'],
            ['key' => 'Séjour minimum',  'value' => '**7 nuits** (samedi → samedi)'],
